...
конечном образе не будет dev зависимостей [Александр Кошелев, Яндекс «Сборка Docker образов без build зависимостей»](https://youtu.be/2fU0SN4UBY0),  
[Копия](https://cloud.mail.ru/public/4CyV/39hXkytCv)
