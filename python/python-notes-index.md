...
7. <h3>[Оптимизация и профилирование](#Оптимизация-и-профилирование)</h3>
...
![](python-notes-index/dict/general-description-and-internal-device/1.jpg)
...
В данном примере функция bar обращается к объемлющей области видимости и 
получает оттуда значение переменной `a`. Данная способность и называется 
замыканием.
