...
<a name='Загрузка-системы-из-оболочки-GRUB'></a>
### Загрузка системы из оболочки GRUB

Для того, чтобы загрузить систему из оболочки GRUB необходимо:

- Найти раздел на котором расположены файлы `vmlinuz` или `linux`, 
    ...
    на единицу до тех пор пока не найдете нужный раздел.
...
<a name='Ручное-указание-дополнительных-DNS-серверов'></a>
